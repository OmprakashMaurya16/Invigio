...
const Button = ({
  ...
  const variants = {
    primary: "bg-primary-600 hover:bg-primary-700 active:bg-primary-800 text-white disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-primary-600",
    secondary:
    ...
    danger: "bg-error-500 hover:bg-error-600 active:bg-error-700 text-white disabled:opacity-50 disabled:cursor-not-allowed focus-visible:ring-error-500",
    outline:
